...
echo True + False; // 2
echo '<br>';
echo gettype(True + False); // Integer
echo '<br>';
echo False + False; // 2
echo '<br>';
echo gettype(False + False); // Integer
echo '<br>';
echo 5 + '5 Lessons'; // 10 => Warning
echo '<br>';
echo gettype(5 + '5 Lessons'); // Integer => Warning
echo '<br>';
echo 5.5 + '5 Lessons'; // 10.5 => Warning
echo '<br>';
echo gettype(5.5 + '5 Lessons'); // Integer => Warning
echo '<br>';
echo 10 + 15.5; // 25.5
echo '<br>';
